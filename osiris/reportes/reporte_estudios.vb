...
Public Class reporte_estudios
    ...
    Private Sub reporte_estudios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For Each dr As DataGridViewRow In busqueda_estudios.dgEstudios.Rows
            dt.Rows.Add(dr.Cells("idestudio").Value, dr.Cells("fecha").Value, dr.Cells("paciente").Value, dr.Cells("edad").Value, dr.Cells("estudio").Value, dr.Cells("medico").Value, dr.Cells("estado").Value)
        Next
